...
(function () {
   ...
   */
  document.querySelectorAll('.navmenu .toggle-dropdown, .navmenu-right .toggle-dropdown').forEach(navmenu => {
  ...
  /**
   * Suppression du compte utilisateur (page profil uniquement)
   */
